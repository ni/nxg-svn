...
namespace Svn.SvnThings
{
    ...
    public sealed partial class SvnItem : SccItem<SvnItem>, ISvnItemUpdate
    {
        ...
        void ScheduleUpdateNotify()
        {
            ...
            //ISvnCommandsService cs = _context.GetService<ISvnCommandsService>();

            //if (cs != null)
            //    cs.PostTickCommand(ref _scheduled, SvnCommands.TickRefreshSvnItems);
        }
        ...
        /// </summary>
        /// <remarks>Use <see cref="Status"/>.<see cref="SvnNodeKind"/> to retrieve the svn type</remarks>
